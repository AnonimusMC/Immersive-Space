...
public class ImmersiveSpace {
    ...
    public static int SPACE_SCALE = 10;
...
//            ShaderProgram shader = VeilRenderSystem.setShader(new ResourceLocation(MOD_ID, "test_space"));
//            ShaderProgram shader = VeilRenderSystem.setShader(new ResourceLocation(MOD_ID, "space"));
//            if (shader == null) {
//                return;
//            }
//
