...
public class CelestialBodies {
    ...
    public static void registerBodies() {
        ...
        MOON = CelestialBody.registerCelestialBody(new Satellite(new ResourceLocation(ImmersiveSpace.MOD_ID, "moon"), EARTH, new Vec3(0,0,30),0.001F, new Vec3(5,5,5),()->PlanetApi.API.getPlanet(earth.terrarium.adastra.api.planets.Planet.MOON)));
        ...
        JUPITER = CelestialBody.registerCelestialBody(new Planet(new ResourceLocation(ImmersiveSpace.MOD_ID, "jupiter"), SUN, new Vec3(0, 0, 500+50), 0.0001673F, 0.01F, new Vec3(40, 40, 40)));
